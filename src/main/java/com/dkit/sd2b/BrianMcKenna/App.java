...
//
//        computerDB1.removeComputerByAssetTag("DKIT-24500D");
//
//        System.out.println(computerDB1);
//
//        System.out.println("\n------TESTING STUDENT DB---------");
...
//        System.out.println(computerBookingDB1);
    ...
    void startUserMenu()
    {
        ...
        } while (menuOptionPicked < 1 || menuOptionPicked > 9);
    ...
    void printMenuOptions()
    {
        ...
        System.out.println("Option 2: Delete Student");
        System.out.println("Option 3: Edit Student");
        System.out.println("Option 4: Add a booking");
        System.out.println("Option 5: Print current bookings");
        System.out.println("Option 6: Print bookings in date/time order");
        System.out.println("Option 7: Return a Computer");
